...
import ResumePDF from "../cv/Sangeetha-K_CV.pdf";
import ProfileOld from "../images/Profile_old.jpg";
import ProfileImg from "../images/Profile-2.jpg"; // Updated to the new profile image
...
const HeroHeading = () => (
  ...
  >
    ...
    <span className="text-lg sm:text-xl md:text-2xl lg:text-4xl">
      aka <span className="text-gradient">SK</span>
    </span>
  </motion.h1>
);
...
const HeroSubtitle = () => (
  ...
  >
    ...
    <br />
    <span className="text-lg sm:text-xl lg:text-2xl text-muted-foreground">
      Specialised in <span className="text-gradient">Front-end</span> and{" "}
      <span className="text-gradient">Scripting</span>.
    </span>
  </motion.div>
);
